...
4. Формат дескриптора `plugin.json`
5. Разработка пользовательских компонентов
6. Жизненный цикл и обработчики событий
7. Платформенные API
8. Тестирование
9. Команды CLI (проектируемая часть)
10. Конфигурация плагинов
11. Модель безопасности
12. Производительность и ограничения ресурсов
13. Примеры
14. Сценарий миграции существующих модулей
15. Интеграция с фреймворком Jmix
16. План дальнейших работ
...
### 3.1. Создание заготовки плагина
...
### 14.1. Создание заготовки

```bash
jmix plugin init my-module --type module
```

### 14.2. Перенос исходного кода
...
### 15.5. Структура JAR-артефакта плагина
